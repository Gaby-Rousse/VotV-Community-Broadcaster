...
<div style="background-color:#0000AA; font-family:Consolas,'DejaVu Sans Mono',Menlo,'Courier New',monospace;">
    ...
    <div style=" margin: 50px auto; max-width: 650px; min-width: 650px; background-color: #AAAAAA;  border-top: 2px solid #FFFFFF; border-left: 2px solid #FFFFFF; border-bottom: 2px solid #000000; border-right:2px solid #000000; ">
        <div style="height: 26px; line-height: 26px; background-color:#0000AA; color: #FFFFFF; text-align: center; letter-spacing: 1px; margin: 4px;">EMAIL VALIDATOR (v0.1)</div>
        <div style="padding: 20px 20px 0 20px;">
            <!--- CONTENT --->
            <div style=" font-size: 18px; letter-spacing: 1px;">PLEASE VERIFY YOUR EMAIL</div>
            <div style="margin-top: 25px; margin-bottom: 25px;">You've received this email because you created a new account on VotV Community Broadcaster</div>
        </div>
        ...
        <div style="padding: 0 20px 20px 20px">
            ...
            <div style="display:grid; gap:10px; margin: 20px 0;">
                <div style="display: flex; gap:10px;">
                    <div style="color: #AA0000">■</div> <div>Please click the "VERIFY NOW" button below.</div>
                </div>
                <div style="display: flex; gap:10px;">
                    <div style="color: #AA0000">■</div> <div>This link is valid for 60 minutes.</div>
                </div>
                <div style="display: flex; gap:10px;">
                    <div style="color: #AA0000">■</div> <div>If you did not create an account, ignore this message.</div>
                </div>
            </div>
            <!--- BUTTON(S) --->
            <div style="display: flex; gap: 20px">
                <a href="{{$url}}" style="background-color: #00AAAA; padding: 8px 22px; font-weight: 500; text-decoration: none; color: #000000; user-select: none; font-size: 18px; border-top: 2px solid #FFFFFF; border-left: 2px solid #FFFFFF; border-bottom: 2px solid #000000; border-right:2px solid #000000;">VERIFY NOW</a>
            </div>
        </div>
