...
<div class="md:border-3 border-solid h-full min-h-screen bg-black flex flex-col p-0.5 text-green-500">
    <div class="ml-1 flex flex-col" id="history">
        <div class="console">Available history</div>

        <div class="console">├──&nbsp;[Audio]</div>
        ...
        <a href="txt/metal_history.txt" class="console">│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">Metal</span></a>
        <a href="txt/pop_history.txt" class="console">│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">Pop</span></a>
        <a href="txt/rock_history.txt" class="console">│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">Rock</span></a>
        <a href="txt/video_game_history.txt" class="console">│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">Video Game</span></a>
        <a href="txt/weird_history.txt" class="console">│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└──&nbsp;<span class="url console">Weird</span></a>

        <div class="console">└──&nbsp;[Video]</div>
        <a href="txt/Main_TV_history.txt" class="console">&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">Main</span></a>
        ...
        <a href="txt/lt5min_history.txt" class="console">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├──&nbsp;<span class="url console">lt5min</span></a>
        <a href="txt/lt30sec_history.txt" class="console">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└──&nbsp;<span class="url console">lt30sec</span></a>
    </div>
</div>
<script>
