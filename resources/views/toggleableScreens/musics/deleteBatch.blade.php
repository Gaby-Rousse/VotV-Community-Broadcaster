<!--- Écran poubelle --->
<form action="/deleteBatch" class="flex-1/2 border-3 border-solid m-0.5 hidden flex-col toggleableScreen" method="post"
    ...
    <div class="flex flex-row">
        <label for="b_confirm" id="confirmationLabel" class="dos flex flex-row gap-1 ml-1 hover:cursor-pointer ">Please
            confirm you want to
            delete
            <div class="selectedCount dos red"></div>
            file(s) (y/n): </label>
        <input id="b_confirm" type="text" class="dos border-none flex-grow hover:cursor-pointer ml-0.5" name="confirm">
    </div>
